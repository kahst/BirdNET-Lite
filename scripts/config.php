...
function runProcess() {
 ...
 // Set the output to "Loading..."
  ...
  xhr.send();
      ...
      <dt>(in-depth technical write-up on the models <a href="https://github.com/mcguirepr89/BirdNET-Pi/wiki/BirdNET-Pi:-some-theory-on-classification-&-some-practical-hints">here</a>)</dt>
      </dl>
      </td></tr></table><br>
