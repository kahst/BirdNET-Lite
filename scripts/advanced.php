...
?>
    ...
    <form action="" method="GET">
      ...
      <input name="recording_length" oninput="document.getElementsByName('recording_length')[0].setAttribute('max', this.value);" type="number" min="3" max="60" step="1" value="<?php print($newconfig['RECORDING_LENGTH']);?>" required/><br>
